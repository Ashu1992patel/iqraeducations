...
<div class="rs-gallery-4 rs-gallery sec-spacer">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="gallery-item">
                    <img src="{{ url('frontend') }}/images/gallery/1.jpg" alt="Gallery Image" />
            ...
            <div class="col-lg-3 col-md-6">
                <div class="gallery-item">
                    <img src="{{ url('frontend') }}/images/gallery/2.jpg" alt="Gallery Image" />
                    <div class="gallery-desc">
                        <h3><a href="#">Photo Title Here</a></h3>
                        <p>There are many variations of Lorem Ipsum available</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="gallery-item">
                    <img src="{{ url('frontend') }}/images/gallery/3.jpg" alt="Gallery Image" />
                    <div class="gallery-desc">
                        <h3><a href="#">Photo Title Here</a></h3>
                        <p>There are many variations of Lorem Ipsum available</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="gallery-item">
                    <img src="{{ url('frontend') }}/images/gallery/4.jpg" alt="Gallery Image" />
                    <div class="gallery-desc">
                        <h3><a href="#">Photo Title Here</a></h3>
                        <p>There are many variations of Lorem Ipsum available</p>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="gallery-item">
                    <img src="{{ url('frontend') }}/images/gallery/5.jpg" alt="Gallery Image" />
                    <div class="gallery-desc">
                        <h3><a href="#">Photo Title Here</a></h3>
                        <p>There are many variations of Lorem Ipsum available</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="gallery-item">
                    <img src="{{ url('frontend') }}/images/gallery/6.jpg" alt="Gallery Image" />
                    <div class="gallery-desc">
                        <h3><a href="#">Photo Title Here</a></h3>
                        <p>There are many variations of Lorem Ipsum available</p>
