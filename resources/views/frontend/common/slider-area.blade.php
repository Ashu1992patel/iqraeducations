                    ...
                    <div class="display-table-cell">
                        {{-- <div class="container text-center">
                            ...
                            <p data-animation-in="fadeInUp" data-animation-out="animate-out" class="slider-desc">
                                ...
                                <br class="hidden-sm-dow"> 
                                Nunc quis sapien in arcu pharetra volutpat.Morbi nec vulputate dolor.
                            </p>
                            <a href="#" class="sl-get-started-btn" data-animation-in="lightSpeedIn" data-animation-out="animate-out">
                                Contact us Now
                            </a>
                        </div> --}}
                    </div>
                ...
                <div class="display-table">
                    <div class="display-table-cell">
                        {{-- <div class="container text-center">
                            ...
                            <a href="#" class="sl-get-started-btn" data-animation-in="fadeInUp" data-animation-out="animate-out">
                                Contact us Now
                            </a>
                        </div> --}}
                    </div>
