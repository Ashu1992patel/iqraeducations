            ...
            <div class="card-body">
                ...
                <form class="form-sample" action="{{ route('course.store') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="duration" name="duration" value="{{ old('duration') }}" placeholder="Duration e.g. 120 minutes/day">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="period" name="period" value="{{ old('period') }}" placeholder="Period e.g. 12 Months">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-check form-check-info">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="assessment" id="assessment1" value="1" {{ old('assessment')==1 ? 'checked' : '' }}>
                                                Yes
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-check form-check-info">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="assessment" id="assessment2" value="0" {{ old('assessment')==0 ? 'checked' : '' }}>
                                                No
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="editor form-control" id="description" name="description" rows="3">{{ old('description') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="editor form-control" id="requirement" name="requirement" rows="3">{{ old('requirement') }}</textarea>
                        @if($errors->has('requirement'))
                        <div class="error">{{ $errors->first('requirement') }}</div>
                        @endif
                    </div>
                    <div class="form-group">
                        <button class="btn btn-info btn-block btn-lg">Save</button>
                    </div>
                </form>
            </div>
        </div>
